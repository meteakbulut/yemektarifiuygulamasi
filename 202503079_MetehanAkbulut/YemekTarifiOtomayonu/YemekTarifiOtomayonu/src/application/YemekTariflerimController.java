...
public class YemekTariflerimController {
    ...
    private int USER_ID;
    @FXML
    void btnEkleOnClick(ActionEvent event) {
    	...
    	db.YemekTarifiEkle(Baslik, Aciklama, ResimUrl);
    	initialize();
    }
    ...
    void initialize() {
    	...
    	for (YemekTarifi item : db.YemekTarifiListesiKullaniciId(USER_ID)) {
    		items.add(item);
    	}
